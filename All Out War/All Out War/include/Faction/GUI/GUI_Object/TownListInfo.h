#ifndef TOWNLISTINFO_H
#define TOWNLISTINFO_H

#include "Faction\GUI\GUI_Object\SideMenu.h"

class TownListInfo : public SideMenu
{
protected:
public:
	///<summary> 
	...
	TownListInfo(Ogre::String Name, Ogre::String materialname,Ogre::Vector2 screensize);
	///<summary> 
	///Destructor
	///</summary>
	~TownListInfo();
